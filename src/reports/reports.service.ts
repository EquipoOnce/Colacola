...
export class ReportsService {
  ...
  async createReport(input: CreateReportInput) {
    ...
    if (!incident) throw new NotFoundException('Incidente no encontrado después de crear');
   ...
   async updateMyReport(userId: number, incidentId: number, input: UpdateMyReportInput) {
